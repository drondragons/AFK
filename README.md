# <p align="center">Курс АФК на время академического отпуска</p>
...
<p align="justify">Отдельно выложил лист учёта, который необходимо заполнить, для выхода из академического отпуска и требования по оформлению реферата из НейроSPOC.</p>
